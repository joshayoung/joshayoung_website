...
export default () => (
  <dl>
    ...
    <dd>
      CREATE USER my_user_name WITH PASSWORD 'MY_PASSWORD'; CREATE DATABASE
      my_user_db; GRANT ALL PRIVILEGES ON DATABASE my_user_db to my_user_name;
    </dd>
    ...
    <dt>Create User</dt>
    <dd>
      <code>CREATE USER myuser WITH PASSWORD 'my password';</code>
    </dd>
    <dt>Create Role</dt>
    <dd>
      <code>CREATE ROLE myuser WITH LOGIN PASSWORD 'my password';</code>
    </dd>
    <dt>Alter Role</dt>
    <dd>
      <code>ALTER USER myuser WITH CREATEDB;</code>
    </dd>
  </dl>
);
